...
public class LiveStripeResponseGetter implements StripeResponseGetter {
	...
	private static <T> T _oAuthRequest(APIResource.RequestMethod method,
								  String url, Map<String, Object> params, Class<T> clazz,
								  APIResource.RequestType type, RequestOptions options)
			throws AuthenticationException, InvalidRequestException,
	...
	private static void handleOAuthError(String rBody, int rCode, String requestId)
			throws InvalidClient, InvalidGrantException, com.stripe.exception.oauth.InvalidRequestException, InvalidScopeException,
